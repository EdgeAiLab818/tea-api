...
2. **事実確認の場合**:
  - **【厳格な引用】**: 【データ】内に記述がない商品名は、絶対に回答に含めないでください。一般的な知識で「ほうじ茶なら〇〇があるはず」と推測してはいけません。
...
【計算ドラフト】にある具体的な情報（商品名、価格、送料の結論）を「一切削らずに」接客文を作成してください。
...
清書ルール:
1. **情報の保持（重要）**: 【計算ドラフト】に記載されている「具体的な商品名」や「価格」は、要約したり「豊富ですね」とまとめたりせず、必ず全て回答に含めてください。
